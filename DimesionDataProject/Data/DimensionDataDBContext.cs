...
namespace DimesionDataProject.Data
{
    public partial class DimensionDataDBContext : DbContext
    {
        public DimensionDataDBContext()
        {
        }

        public DimensionDataDBContext(DbContextOptions<DimensionDataDBContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<DimensionDataProjectDb> DimensionDataProjectDb { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=DimensionDataDB; Data Source=THATO\\MSSQLSERVER01;Trusted_Connection=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DimensionDataProjectDb>(entity =>
            {
                entity.HasKey(x=>x.EmployeeNumber);

                entity.ToTable("DimensionDataProjectDB");
